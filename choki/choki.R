...
m0 <- runit("1_1.00",pdf=TRUE,portrait=F,est=TRUE,exec="../src/jjm")
m1 <- runit("1_1.01",pdf=TRUE,portrait=F,est=TRUE,exec="../src/jjm")
m2 <- runit("1_1.02",pdf=TRUE,portrait=F,est=TRUE,exec="../src/jjm")
m3 <- runit("1_1.03",pdf=TRUE,portrait=F,est=TRUE,exec="../src/jjm")
m4 <- runit("1_1.04",pdf=TRUE,portrait=F,est=TRUE,exec="../src/jjm")
m5 <- runit("1_1.05",pdf=TRUE,portrait=F,est=TRUE,exec="../src/jjm")
...
plot(ret1, var="SSB",xlim) # only SSB
